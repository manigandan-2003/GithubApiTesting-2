...
```
The provided code is already optimal for a linear search.  There's no faster general algorithm for finding an element in an unsorted array/matrix than linear search.  To improve performance for sorted data, you would use binary search.
